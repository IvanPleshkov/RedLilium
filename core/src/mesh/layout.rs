...
impl VertexLayout {
    ...
    ///
    /// Used for simple textured meshes like quads and sprites.
...
mod tests {
    ...
    fn test_common_layouts() {
        ...
        let pos_uv = VertexLayout::position_uv();
        assert_eq!(pos_uv.buffer_count(), 1);
        assert_eq!(pos_uv.buffer_stride(0), 20);
